...
using FileAccessDemo.FileAccessDemo_XamlTypeInfo;
...
namespace FileAccessDemo.FileAccessDemo_XamlTypeInfo
{
    ...
    internal partial class XamlTypeInfoProvider
    {
        ...
        private object Activate_0_MainPage() { return new FileAccessDemo.MainPage(); }
        ...
        private IXamlType CreateXamlType(string typeName)
        {
            ...
            case "FileAccessDemo.MainPage":
                userType = new XamlUserType(this, typeName, typeof(FileAccessDemo.MainPage), GetXamlTypeByName("Windows.UI.Xaml.Controls.Page"));
